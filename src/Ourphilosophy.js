...
import Danielcar from "./component/Danielcar" ;
                ...
                <div className="hidden md:block  ">
                    <div className="md:grid md:grid-cols-3  ">
                        <div className="md:border-r md:border-black md:pr-[10px] md:mr-[10px] lg:border-0 lg:pr-0 lg:mr-0 xl:pr-[0px]   ">
                             ...
                             <img className='h-[300px] w-[250px] lg:h-[300px] lg:w-[300px] xl:h-[50vh] xl:w-[600px] ' src= {require('./assets/mayoimg/4e.jpeg')} alt=""/>
                        ...
                        <div className="md:border-r md:border-black md:pr-[10px] lg:border-0 lg:border-l  lg:border-black lg:pl-[20px] xl:ml-[20px]  ">
                            <img className='h-[300px] w-[250px] lg:h-[300px] lg:w-[300px] xl:h-[50vh] xl:w-[600px] ' src= {require('./assets/mayoimg/5b.jpeg')} alt="" />
                        ...
                        <div className="md:ml-[10px]    lg:border-black lg:border-l lg:pl-[20px]  ">
                            <img className='h-[300px] w-[250px] lg:h-[300px] lg:w-[300px] xl:h-[50vh] xl:w-[600px] ' src= {require('./assets/mayoimg/5c.jpeg')} alt="" />
