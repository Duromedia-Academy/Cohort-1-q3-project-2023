    ...
    return(
        ...
        <OwlCarousel className= " owl-carousel owl-theme px-4   " {...options}>
                    ...
                    <div className=" items p-[10px]  ">
                        <img className='h-[100px] 'src= {require('../assets/mayoimg/4ei.jpeg')} alt=""/>
                    ...
                    <div className=" items p-[10px] pt-[20px] ">
                        <img className='h-[100px] 'src= {require('../assets/mayoimg/5b.jpeg')} alt="" />
                    ...
                    <div className=" items p-[10px]">
                        <img className='h-[100px] 'src= {require('../assets/mayoimg/5c.jpeg')} alt="" />
