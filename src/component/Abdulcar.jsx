        ...
        const Abdulcar = () => {
            return (
                <OwlCarousel className="owl-carousel owl-theme bg-bg-white " {...options}>
                    ...
                    <div className=" px-[20px] grid md-grid-col-2 border border-b-0   border-black border-r-0 border-l-0 md:flex lg:flex-row">
                    ...
                    <div className=" px-[20px] grid md-grid-cols-2 border border-b-0 border-r-0 border-l-0">
                    ...
                    <div className=" px-[20px] grid md-grid-cols-2 border border-b-0  border-black border-r-0 border-l-0">
                    <div className="p-4"><video src={require('../assets/video/webbandwallet.mp4')}></video></div>
                    <div className='pl-1 mt-36'>
                        <p></p>
                        <p>CARDPROTECTOR</p>
                    ...
                    <div className=" px-[20px] grid md-grid-cols-2 border border-b- border-r-0 border-l-0">
                    <div className="p-4"><video src={require('../assets/video/home-2.mp4')}></video></div>
                    <div className='pl-1 mt-36'>
                        <p>10 colors</p>
                        <p>CARDPROTECTOR</p>
